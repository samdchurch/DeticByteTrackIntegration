...
from BYTE import linear_assignment
from BYTE import iou_matching
from BYTE import kalman_filter

from BYTE.detection import Detection
from BYTE.track import Track
...
class Tracker:
    ...
    def get_current_tracks(self):
        ...
        for track in self.tracks:
            ...
            outputs.append(np.array([box[0], box[1], box[2], box[3], track_id, class_id, track.state], dtype=np.int32))
        if len(outputs) > 0:
